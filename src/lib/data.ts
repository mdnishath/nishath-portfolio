...
export const projects: Project[] = [
  {
    ...
    image: "/uploads/project-couverturejjm.webp",
  ...
  {
    slotId: "work-autocomplete-address",
    title: "Autocomplete Google Address",
    desc: "WordPress plugin with 2,000+ active installs — real-time Google address suggestions for checkout, contact and custom forms. Published on WordPress.org.",
  ...
  {
    slotId: "work-wp-ultra-mcp",
    title: "WP-Ultra-MCP",
    desc: "Free, open-source WordPress plugin that turns any WP site into an MCP server — AI clients like Claude and Gemini can manage files, SQL, WP-CLI and content directly.",
  ...
  },
  {
    slotId: "work-bondhu",
    title: "Bondhu",
    desc: "Self-hosted, multi-account WhatsApp client with real-time two-way translation — type in Bengali, your contact reads it in their language. Web, Android & voice notes.",
    image: "/uploads/project-bondhu.webp",
    href: "https://github.com/mdnishath/Bondhu",
    github: "https://github.com/mdnishath/Bondhu",
    tags: ["TypeScript", "Kotlin", "AI Translation"],
  },
];
